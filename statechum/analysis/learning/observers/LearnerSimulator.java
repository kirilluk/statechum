...
public class LearnerSimulator extends ProgressDecorator implements Learner 
{
	 ...
	 */
	public int CheckWithEndUser(@SuppressWarnings("unused") computeStateScores g, 
			@SuppressWarnings("unused")	List<String> question, Object[] options) 
	{
		return Integer.valueOf(currentElement.getAttribute(ELEM_KINDS.ATTR_FAILEDPOS.name()));
	}
	...
	public Stack<PairScore> ChooseStatePairs(computeStateScores graph)
	{
		...
		for(int i=0;i<Pairs.getLength();++i)
		{
			...
			if (pair.getNodeType() == org.w3c.dom.Node.ELEMENT_NODE)
			{
				...
				result.add(readPair(graph.getGraph(), elem));
			}
		}
		return result;
	}
	...
	public List<List<String>> ComputeQuestions(@SuppressWarnings("unused") PairScore pair, 
			@SuppressWarnings("unused")	computeStateScores original, @SuppressWarnings("unused") computeStateScores temp)
	{
	 ...
	 */
	public void AugmentPTA(@SuppressWarnings("unused") computeStateScores pta, 
	 ...
	 */
	@Override
	public DirectedSparseGraph learnMachine(@SuppressWarnings("unused") Collection<List<String>> plus, 
	 ...
	 */
	@Override
	public DirectedSparseGraph learnMachine(@SuppressWarnings("unused") PTATestSequenceEngine engine, 
			@SuppressWarnings("unused") int plusSize, 
			@SuppressWarnings("unused") int minusSize)
	{
		return learnMachine();
