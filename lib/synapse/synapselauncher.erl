...
selectOtpLibrary() ->
  case erlang:system_info(otp_release) of
    ...
    15 ->"lib/OtpErlang/14/OtpErlang.jar";
...
% by passing false when starting Synapse. This problem occurs every time Quickcheck is used to start Statechum because it uses a separate process that terminates when Quickcheck test does.  
	...
	JavaDefaultsList = [
		{'-cp',["bin","lib/colt.jar","lib/commons-collections-3.1.jar","lib/jung-1.7.6.jar","lib/sootclasses.jar","lib/jltl2ba.jar",selectOtpLibrary(),"lib/junit-4.8.1.jar","lib/javaGD.jar","lib/JRI.jar","lib/weka.jar"]},
