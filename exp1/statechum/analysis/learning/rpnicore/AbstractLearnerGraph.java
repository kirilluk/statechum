...
abstract public class AbstractLearnerGraph<TARGET_TYPE,CACHE_TYPE extends CachedData<TARGET_TYPE,CACHE_TYPE>> 
{
	 ...
	 */
	public abstract void addTransition(Map<String,TARGET_TYPE> row,String input,CmpVertex target);
	 ...
	 */
	public abstract void removeTransition(Map<String,TARGET_TYPE> row,String input,CmpVertex target);	
