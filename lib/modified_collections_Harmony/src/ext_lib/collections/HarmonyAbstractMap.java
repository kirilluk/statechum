 ...
 * @since 1.2
 */
public abstract class HarmonyAbstractMap<K, V> implements Map<K, V> {
    ...
    /**
     * Constructs a new instance of this {@code HarmonyAbstractMap}.
     */
    protected HarmonyAbstractMap() {
        super();
    }
    ...
    protected Object clone() throws CloneNotSupportedException {
        HarmonyAbstractMap<K, V> result = (HarmonyAbstractMap<K, V>) super.clone();
        result.keySet = null;
