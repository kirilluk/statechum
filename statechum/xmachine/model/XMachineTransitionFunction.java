...
/**
 * An X-Machine transition function is an extension of conventional transition
 * functions. X-Machines allow the developer to specify a function not only in
 * terms of input and output, but also in terms of a transformation from one
 * memory state to another. Notably, an X-Machine function can itself be
 * represented as an X-Machine, resulting in a hierarchy.
 * 
