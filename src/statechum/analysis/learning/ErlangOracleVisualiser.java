...
public class ErlangOracleVisualiser extends PickNegativesVisualiser {
	...
	/** Converts Erlang graph into the one where labels do not contain module names, but they are still Erlang labels. */
    ...
    /** Converts Erlang graph to simple graph without module names and with all labels string labels. */
