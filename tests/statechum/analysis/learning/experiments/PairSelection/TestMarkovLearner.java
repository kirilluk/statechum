...
public class TestMarkovLearner 
{
	...
	public void testUpdateMarkovSideways3()
	{
		...
		Assert.assertEquals(MarkovOutcome.negative,mPredictionsMatrix.get(Arrays.asList(lblB,lblU)));
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblB,lblB)));
	...
	public void testUpdateMarkovSideways4()
	{
		...
		Map<List<Label>,MarkovOutcome> mPredictionsMatrix = m.computePredictionMatrix();
		Assert.assertEquals(6,mPredictionsMatrix.size());
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblA,lblB,lblC)));
		...
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblC,lblU,lblA)));
		
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblC,lblC,lblC)));
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblC,lblC,lblA)));
	}
	...
	public void testPredictTransitionsSideways2()
	{
		...
		Assert.assertEquals(MarkovOutcome.failure,mPredictionsMatrix.get(Arrays.asList(lblB,lblU)));
		...
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblU,lblB)));
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblB,lblB)));
		Assert.assertEquals(MarkovOutcome.positive,mPredictionsMatrix.get(Arrays.asList(lblU,lblU)));
	}
	...
	public void testPredictTransitionsFromStatesForward2b()
	{
		...
		predictions = new MarkovClassifier(new MarkovModel(2,false,true,markovPTAUseMatrix),graph2).predictTransitions();
		Assert.assertTrue(predictions.isEmpty());
	}
	...
	public void testPredictTransitionsFromStatesWithPathBeyondCurrentState1()
	{
		...
		final LearnerGraph graph2 = FsmParser.buildLearnerGraph("A-a->B / A-c->A / T-u->T-b->T","testCheckFanoutInconsistencySideways4",config, converter);// T is there to ensure that graph2's alphabet is the same as that of graph.
		Map<Label, MarkovOutcome> predictions = new MarkovClassifier(m, graph2).predictTransitionsFromState(graph2.getInit(), List.of(),m.getChunkLen(),null);
	...
	public void testPredictTransitionsFromStatesWithPathBeyondCurrentState2()
	{
		...
		Helper.checkForCorrectException(
				() -> new MarkovClassifier(m, graph2).predictTransitionsFromState(graph2.getInit(), Collections.singletonList(lblC),m.getChunkLen(),null),
	...
	public void testPredictTransitionsFromStatesWithPathBeyondCurrentState3()
	{
		...
		final LearnerGraph graph2 = FsmParser.buildLearnerGraph("A-a->B / A-c->A/ T-u->T-b->T","testPredictTransitionsFromStatesForward2",config, converter);
		Map<Label,MarkovOutcome> outgoing_labels_probabilities=new MarkovClassifier(m, graph2).predictTransitionsFromState(graph2.findVertex("B"), List.of(),m.getChunkLen(),null);
	...
	public void testPredictTransitionsFromStatesWithPathBeyondCurrentState4()
	{
		...
		Map<Label,MarkovOutcome> outgoing_labels_probabilities=new MarkovClassifier(m, graph2).predictTransitionsFromState(graph2.findVertex("B"), Collections.singletonList(lblA),m.getChunkLen(),null);
		Assert.assertEquals(2,outgoing_labels_probabilities.size());
		Assert.assertEquals(MarkovOutcome.negative,outgoing_labels_probabilities.get(lblU));
		Assert.assertEquals(MarkovOutcome.positive,outgoing_labels_probabilities.get(lblB));
	}
	...
	public void testPredictTransitionsFromStatesWithPathBeyondCurrentState5()
	{
		...
		final LearnerGraph graph2 = FsmParser.buildLearnerGraph("A-d->B / A-c->A/ T-u->T-b->T","testPredictTransitionsFromStatesForward2",config, converter);
		Helper.checkForCorrectException(
				() -> new MarkovClassifier(m, graph2).predictTransitionsFromState(graph2.findVertex("B"),Arrays.asList(lblA,lblB),m.getChunkLen(),null),
	...
	public void testLabelStatesAwayFromRoot2()
	{
		...
		Set<CmpVertex> expected = new TreeSet<>(Collections.singletonList(graph.findVertex("A"))), actual = new TreeSet<>(graph.additionalExplorationRoot);
	...
	public void testLabelStatesAwayFromRoot3()
	{
		...
		Set<CmpVertex> expected = new TreeSet<>(Arrays.asList(graph.findVertex("B"), graph.findVertex("C"))), actual = new TreeSet<>(graph.additionalExplorationRoot);
		Assert.assertEquals(expected,actual);
	}
	...
	public void testBuildVerticesToMergeForPath1()
	{
		...
		Collection<Set<CmpVertex>> collectionOfSets=new MarkovClassifier(new MarkovModel(2,true,true,markovPTAUseMatrix),gr).buildVerticesToMergeForPaths(paths);
