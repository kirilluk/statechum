...
//														ScoringToApply.SCORING_EDSM_1, ScoringToApply.SCORING_EDSM_2
                                    ...
                                    for (final int chunkSizeToEvaluate : learnerKind.isMarkov() ? new int[]{3} : new int[]{2})
                                        for (double weightOfInconsistencies : learnerKind.isMarkov() ? new double[]{2.0} : new double[]{1.0})
        ...
        if (learningGroup.phase == SGE_ExperimentRunner.PhaseEnum.COLLECT_AVAILABLE || learningGroup.phase == SGE_ExperimentRunner.PhaseEnum.COLLECT_RESULTS) {
            ...
            final SquareBagPlot gr_StructuralDiffBest = new SquareBagPlot("Structural score, Sicco", "Structural Score, EDSM-Markov learner", new File(learningGroup.outPathPrefix + "_" + statesMax + "_sicco_structuraldiffBest.pdf"), 0, 1, true);
