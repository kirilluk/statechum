 ...
 >>>>>>> .merge-right.r793
    ...
    */
    ...
    public DifferenceToReference learnAndEstimateDifference(int ifDepth,LearnerGraph initPTA, LearnerGraph referenceGraph,Classifier c, final Collection<Label> labelsToMergeTo, final Collection<Label> labelsToMergeFrom)
    {
 		...
 		UseWekaResultsParameters parameters = new UseWekaResultsParameters(new DataCollectorParameters(ifDepth, null, true,true, DataCollectorParameters.enabledAll())); 	
 		MarkovParameters markovParameters = new MarkovParameters(0, 3,1, true,1,0,1);
     	WekaDataCollector dataCollector = PairQualityLearner.createDataCollector(new DataCollectorParameters(ifDepth,null,true,true, DataCollectorParameters.enabledAll()), new MarkovHelper(markovParameters));
