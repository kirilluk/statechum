...
final public class TestAugmentUsingIFTHEN 
{
	...
	public final void testPerformAugment5a() throws IncompatibleStatesException
	{
		...
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-d->N1 / B-b->C-a->B1-b->C1/ B1-d->N2 / C-c->S1-c->S2", "testPerformAugment5a"),config), graph);
	}
	...
	public final void testPerformAugment5b() throws IncompatibleStatesException
	{
		...
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-d->N1 / B-b->C-a->B1-b->C1-a->B2/ B1-d->N2 / C-c->S1-c->S2-c->S3 / C1-c->S11", "testPerformAugment5b"),config), graph);
	}
	...
	public final void testPerformAugment5c() throws IncompatibleStatesException
	{
		...
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-d->N1 / B-b->C-a->B1-b->C1-a->B2-b->C2/ B1-d->N2 / B2-d->N3 / C-c->S1-c->S2-c->S3-c->S4 / C1-c->S11-c->S12", "testPerformAugment5c"),config), graph);
	}
	...
	public final void testPerformAugment5d() throws IncompatibleStatesException
	{
		...
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph(ifthenC, "ifthenC"), config)}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 5);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-d->N1 / B-b->C-a->B1-b->C1-a->B2-b->C2-a->B3/ B1-d->N2 / B2-d->N3 / C-c->S1-c->S2-c->S3-c->S4-c->S5"+
	...
	{
		Configuration config = Configuration.getDefaultConfiguration();
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-a->B", "testPerformAugment6a"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph("A-a->B-a->B /  T-b-#N / B=THEN=T", "testPerformAugment_fail1"), config)}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 2);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#N1", "testPerformAugment6a"),config), graph);
	}
	...
	{
		Configuration config = Configuration.getDefaultConfiguration();
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#C", "testPerformAugment6b"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph("A-a->B-a->B /  T-b-#N / B=THEN=T", "testPerformAugment_fail1"), config)}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 2);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#N1", "testPerformAugment6a"),config), graph);
	}
	...
	{
		Configuration config = Configuration.getDefaultConfiguration();
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#C / B-a->D", "testPerformAugment6c"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph("A-a->B-a->B /  T-b-#N / B=THEN=T", "testPerformAugment_fail1"), config)}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 2);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#N1 / B-a->D-b-#N2", "testPerformAugment6c"),config), graph);
	}
	...
	{
		Configuration config = Configuration.getDefaultConfiguration();
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#C / B-a->D-b-#N2", "testPerformAugment6d"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph("A-a->B-a->B /  T-b-#N / B=THEN=T", "testPerformAugment_fail1"), config)}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 2);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-b-#N1 / B-a->D-b-#N2", "testPerformAugment6c"),config), graph);
	}
	...
	public final void testPerformAugment16a() throws IncompatibleStatesException
	{
		...
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{
				...
				new LearnerGraph(FsmParser.buildGraph("1A-a->1B-c->1C / 1P-d->1Q / 1C==THEN==1P", "testPerformAugment16a"), config)				
		}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 400);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("bA-a->bB-b->bA / bB-c->bC-d->bD-e->bE", "testPerformAugment16a"),config), graph);
	}
	...
	public final void testPerformAugment16b() throws IncompatibleStatesException
	{
		...
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-a->B-b->A", "testPerformAugment15a"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{
				new LearnerGraph(FsmParser.buildGraph("A-a->B-b->C-a->D-b->E / B-c->F-d->G / P-a->Q-c->S / T-e->U / E==THEN==P / G==THEN==T /"+
						"D-c->D2-d->R / RB1-d->RB2 / R == THEN == RB1 ", "testPerformAugment16c"), config),
				new LearnerGraph(FsmParser.buildGraph("1A-a->1B-c->1C / 1P-d->1Q / 1C==THEN==1P", "testPerformAugment16a"), config)				
		}; 
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 400);
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("bA-a->bB-b->bA / bB-c->bC-d->bD-e->bE / bD-d->bF", "testPerformAugment16b"),config), graph);
	}
	...
	{
		Configuration config = Configuration.getDefaultConfiguration();
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-b->B-c->A-c->B", "testPerformAugment17"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{
				new LearnerGraph(FsmParser.buildGraph(ifthen_a_to_c, "ifthen_a_to_c"), config),
		...
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-b->B-c->A-c->B / "+
				"A-a->A1-b->B1 / "+
				"B-a->A2-b->B2 / "+
	...
	{
		Configuration config = Configuration.getDefaultConfiguration();
		LearnerGraph graph = new LearnerGraph(FsmParser.buildGraph("A-a->B-b->C-a->D-b->E-a->F-b->G", "testPerformAugment19"),config);
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{
				new LearnerGraph(FsmParser.buildGraph(ifthen_ab_to_c, "ifthen_ab_to_c"), config),
				new LearnerGraph(FsmParser.buildGraph(ifthen_c_to_cc, "ifthen_c_to_cc"), config),			
				new LearnerGraph(FsmParser.buildGraph(ifthen_ccc_to_ab, "ifthen_ccc_to_ab"), config)
		...
		Transform.augmentFromIfThenAutomaton(graph, null, ifthenCollection, 7);
		//Visualiser.updateFrame(graph, null);Visualiser.waitForKey();
		compareGraphs(new LearnerGraph(FsmParser.buildGraph("A-a->B-b->C-a->D-b->E-a->F-b->G / "+
	...
	public final void testQuestionAnswering1() throws IncompatibleStatesException
	{
		...
		LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph("A-s->B / P-c->Q-d-#R / S-c->S1-c->S2-e->S3 / S==THEN==A==THEN==P", "testQuestionAnswering1"), config)}; 
	...
	public static final class TestQuestionPTA
	{
		...
		{
			LearnerGraph[] ifthenCollection = new LearnerGraph[]{new LearnerGraph(FsmParser.buildGraph(ifthen_sc_unsat, "ifthen_sc"), config)}; 
			Transform.augmentFromIfThenAutomaton(graph, (NonExistingPaths)questions.getFSM(), ifthenCollection, 0);
			compareGraphs(new LearnerGraph(origGraph,config),graph);// check that augment did not modify the automaton
			graph.learnerCache.questionsPTA=questions;
			Assert.assertEquals(3,questions.getData().size());
