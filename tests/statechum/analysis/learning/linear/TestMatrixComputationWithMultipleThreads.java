...
*/
	...
	{
		LearnerGraph gr = buildLearnerGraph(machineCompatibility1,"TestComputeStateCompatibility1",config,converter);
		PairScoreComputation.LinearScoring<CmpVertex,LearnerGraphCachedData> ndComputation = new PairScoreComputation.LinearScoring<CmpVertex,LearnerGraphCachedData>(gr,threadNumber,null,LearnerGraphND.ignoreRejectStates, new NonRandomRandom());
	...
	public final void TestComputeStateCompatibility1b_WalksRH()
	{
		...
		PairScoreComputation.LinearScoring<CmpVertex,LearnerGraphCachedData> ndComputation = new PairScoreComputation.LinearScoring<CmpVertex,LearnerGraphCachedData>(gr,threadNumber,DDRH_BCR.class,
	...
	{
		LearnerGraph gr=buildLearnerGraph(machineCompatibility2,"TestComputeStateCompatibility1",config,converter);
		PairScoreComputation.LinearScoring<CmpVertex,LearnerGraphCachedData> ndComputation = new PairScoreComputation.LinearScoring<CmpVertex,LearnerGraphCachedData>(gr,threadNumber,null,
				LearnerGraphND.ignoreRejectStates, new NonRandomRandom());
