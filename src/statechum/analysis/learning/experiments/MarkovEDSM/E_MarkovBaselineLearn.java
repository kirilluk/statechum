        ...
        if (learningGroup.phase == SGE_ExperimentRunner.PhaseEnum.COLLECT_AVAILABLE || learningGroup.phase == SGE_ExperimentRunner.PhaseEnum.COLLECT_RESULTS) {// by the time we are here, experiments for the current number of states have completed, hence record the outcomes.
            ...
            for (int states : learningGroup.statesToUse) {
                ...
                for (int perStateSquaredDensity100 : MarkovExperiment.densityFromStateNumber(states)) {
                    ...
                    final DrawGraphs.SquareBagPlot gr_StructuralDiff = new DrawGraphs.SquareBagPlot("Structural score, HV", "Structural Score, EM", new File(experimentName + "HV_structuraldiff.pdf"), 0, 1, true);
                    final DrawGraphs.SquareBagPlot gr_StructuralDiffLowDensity =
                            (perStateSquaredDensity100 == 0) ?
                                    new DrawGraphs.SquareBagPlot("Structural score, HV", "Structural Score, EM", new File(experimentName + "lowdensity_HV_structuraldiff.pdf"), 0, 1, true)
                                    : null;
                    ...
                    final DrawGraphs.SquareBagPlot gr_DiffAgainstKtails1 = new DrawGraphs.SquareBagPlot("Structural Score, K-tails,1", "Structural Score, EM", new File(experimentName + "kt_1_markov.pdf"), 0, 1, true);
                    final DrawGraphs.SquareBagPlot gr_DiffAgainstKtails2 = new DrawGraphs.SquareBagPlot("Structural Score, K-tails,2", "Structural Score, EM", new File(experimentName + "kt_2_markov.pdf"), 0, 1, true);
                    final DrawGraphs.SquareBagPlot gr_DiffAgainstEDSM_1 = new DrawGraphs.SquareBagPlot("Structural Score, EDSM-1", "Structural Score, EM", new File(experimentName + "edsm-1_markov.pdf"), 0, 1, true);
                    final DrawGraphs.SquareBagPlot gr_DiffAgainstEDSM_2 = new DrawGraphs.SquareBagPlot("Structural Score, EDSM-2", "Structural Score, EM", new File(experimentName + "edsm-2_markov.pdf"), 0, 1, true);
