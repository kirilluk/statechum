...
public class TestSGE_ExperimentRunner
{
	...
	final MockPlot<String> gr_StructuralDiff = new MockPlot<>("Structural score, HV", "Structural Score, EDSM-Markov learner", new File("tmp/runA_struct.pdf"));
	final MockPlot<String> gr_BCR = new MockPlot<>("BCR, HV", "BCR, EDSM-Markov learner", new File("tmp/runA_BCR.pdf"));
	final MockPlot<String> gr_a = new MockPlot<>("Structural score, HV", "Structural Score, EDSM-Markov learner", new File("tmp/runA_a.pdf"));
	final MockPlot<String> gr_b = new MockPlot<>("BCR, HV", "BCR, EDSM-Markov learner", new File("tmp/runA_b.pdf"));
	...
	public int runA(String []args)
	{
		...
		experimentRunner.collectOutcomeOfExperiments(new processSubExperimentResult<TestParameters,ExperimentResult<TestParameters>>() {
				...
				{
					experimentrunner.RecordR(gr_StructuralDiff, (double) result.parameters.value, (double) (result.parameters.value + 1),null,null);
					experimentrunner.RecordR(gr_BCR, (double) (result.parameters.value + 1), (double) (result.parameters.value - 1),null,null);
				}
	...
	public int runB_both_labels_and_colours(String []args)
	{
		...
		experimentRunner.collectOutcomeOfExperiments(new processSubExperimentResult<TestParameters,ExperimentResult<TestParameters>>() {
				...
				public void processSubResult(ExperimentResult<TestParameters> result, RunSubExperiment<TestParameters,ExperimentResult<TestParameters>> experimentrunner) throws IOException 
				{
					experimentrunner.RecordR(gr_StructuralDiff, (double) result.parameters.value, (double) (result.parameters.value + 1),"dd"+ (double) (result.parameters.value + 1),null);
					experimentrunner.RecordR(gr_BCR, (double) (result.parameters.value + 1), (double) (result.parameters.value - 1),null,"tt"+ (double) (result.parameters.value + 1));
				}
		...
		experimentRunner.collectOutcomeOfExperiments(new processSubExperimentResult<TestParameters,ExperimentResult<TestParameters>>() {
				...
				public void processSubResult(ExperimentResult<TestParameters> result, RunSubExperiment<TestParameters,ExperimentResult<TestParameters>> experimentrunner) throws IOException 
				{
					if (result.parameters.value >= 1)
						experimentrunner.RecordR(gr_StructuralDiff, (double) (result.parameters.value + 1), (double) (result.parameters.value + 1),"dd"+ (double) (result.parameters.value + 1),null);// invalid data is an instance of class file rather than an instance of
					else
						experimentrunner.RecordR(gr_StructuralDiff,new java.io.File("gg"+result), (double) (result.parameters.value + 1),"dd"+ (double) (result.parameters.value + 1),null);
					experimentrunner.RecordR(gr_BCR, (double) (result.parameters.value + 1), (double) (result.parameters.value - 1),null,"tt"+ (double) (result.parameters.value + 1));
				}
	...
	public int runMultiple(String []args)
	{
		...
		experimentRunner.collectOutcomeOfExperiments(new processSubExperimentResult<TestParameters,ExperimentResult<TestParameters>>() {
				...
				public void processSubResult(ExperimentResult<TestParameters> result, RunSubExperiment<TestParameters,ExperimentResult<TestParameters>> experimentrunner) throws IOException 
				{
					experimentrunner.RecordR(gr_a, (double) result.parameters.value, (double) (result.parameters.value + 2),"aa"+ (double) (result.parameters.value + 1),"bb"+ (double) (result.parameters.value + 1));
					experimentrunner.RecordR(gr_b, (double) (result.parameters.value + 1), (double) (result.parameters.value - 1),null,null);
				}
	...
	{
		final MockPlot<String> gr = new MockPlot<>("Structural score, HV", "Structural Score, EDSM-Markov learner", new File("tmp/|runA_struct.pdf"));
		RunSubExperiment<TestParameters,ExperimentResult<TestParameters>> experimentRunner = new RunSubExperiment<>(1, ExperimentRunner.testDir, args);
		for(int sample=0;sample<3;++sample)
		{
			DummyExperiment<TestParameters> learnerRunner = new DummyExperiment<>(new TestParameters("row", sample), null, ExperimentRunner.testSGEDirectory);
		...
		experimentRunner.collectOutcomeOfExperiments(new processSubExperimentResult<TestParameters,ExperimentResult<TestParameters>>() {
				...
				public void processSubResult(ExperimentResult<TestParameters> result, RunSubExperiment<TestParameters,ExperimentResult<TestParameters>> experimentrunner) throws IOException 
				{
					experimentrunner.RecordR(gr, (double) result.parameters.value, (double) (result.parameters.value + 1),null,null);
					experimentrunner.RecordR(gr_BCR, (double) (result.parameters.value + 1), (double) (result.parameters.value - 1),null,null);
				}
