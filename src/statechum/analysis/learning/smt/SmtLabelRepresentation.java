 ...
 *
 */
public class SmtLabelRepresentation 
{
		...
		{// Consistency checking
			...
			for(Entry<CmpVertex,Collection<SmtLabelRepresentation.AbstractState>> eqClass:coregraph.getVertexToAbstractState().entrySet())
			{
			 ...
			 // DFA vertex associated to different DFA states, this is to be reported.
				for(SmtLabelRepresentation.AbstractState abstractState:eqClass.getValue())
				{
	...
	*/
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SmtLabelRepresentation))
			return false;
		SmtLabelRepresentation other = (SmtLabelRepresentation) obj;
