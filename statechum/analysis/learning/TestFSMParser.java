...
public class TestFSMParser {
	/**
	 * Used to receive state transitions extracted from textual FSM
	 * representation.
	 */
	...
	protected static class fsmParser {
		...
		protected void throwException(String errMsg) {
			throw new IllegalArgumentException(errMsg + " starting from "
					+ text.substring(lexer.regionStart()));
		}
			...
			do {
				...
				if (left == NEWL) {
					...
					if (left != fsmParser.LABEL)
						throwException("state name expected");// there should
																// be a state
																// name after a
																// newline
				...
				} else if (right != fsmParser.RARROW
						&& right != fsmParser.RARROWREJ)
				...
				else if (left == fsmParser.LARROWREJ)
	...
	protected static class bufferMatcher implements TransitionReceiver {
		...
		public bufferMatcher(String st, String[] data) {
			elements = data;
			text = st;
			assertEquals("incorrect number of elements in the array", true,
					elements.length % 4 == 0);
		}
		...
		public void match() {
			try {
				...
				Error th = new AssertionFailedError();
				th.initCause(e);
				throw th;
			}
			assertEquals("incorrect number of elements in the array",
					elements.length, i);
		}
	}
	...
	public void testFsmParse1() {
		new bufferMatcher(" A-b->C1<-d0-P----a->C\n A- b ->B-a->U",
				new String[] { "A", "C1", "b", "ACCEPT", "P", "C1", "d0",
						"ACCEPT", "P", "C", "a", "ACCEPT", "A", "B", "b",
						"ACCEPT", "B", "U", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse3() {
		new bufferMatcher("", new String[] {}).match();
	}

	@Test
	public void testFsmParse4() {
		new bufferMatcher(" A_string-b->C1<-d0-P----a->C\n A- b ->B-a->U",
				new String[] { "A_string", "C1", "b", "ACCEPT", "P", "C1",
						"d0", "ACCEPT", "P", "C", "a", "ACCEPT", "A", "B", "b",
						"ACCEPT", "B", "U", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse5() {
		new bufferMatcher(" A-b->C.1  ---d0->P--a->C\n A- b.g ->B-a->Qst.ate",
				new String[] { "A", "C.1", "b", "ACCEPT", "C.1", "P", "d0",
						"ACCEPT", "P", "C", "a", "ACCEPT", "A", "B", "b.g",
						"ACCEPT", "B", "Qst.ate", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse6() {
		new bufferMatcher(
				...
				new String[] { "A", "C.1", "b", "ACCEPT", "C.1", "P", "d0",
						"ACCEPT", "P", "C", "a", "ACCEPT", "A", "B", "b.g",
						"ACCEPT", "B", "Qst.ate", "a", "ACCEPT", "Qst.ate",
						"B", "c", "ACCEPT", "B", "C", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse7() {
		new bufferMatcher(
				" A-b-#C.1  ---d0->P--a->C\n A- b.g ->B-a->Qst.ate-c->B-a->C",
				new String[] { "A", "C.1", "b", "REJECT", "C.1", "P", "d0",
						"ACCEPT", "P", "C", "a", "ACCEPT", "A", "B", "b.g",
						"ACCEPT", "B", "Qst.ate", "a", "ACCEPT", "Qst.ate",
						"B", "c", "ACCEPT", "B", "C", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse8() {
		new bufferMatcher(
				...
				new String[] { "A", "C.1", "b", "ACCEPT", "C.1", "P", "d0",
						"ACCEPT", "P", "C", "a", "ACCEPT", "A", "B", "b.g",
						"REJECT", "B", "Qst.ate", "a", "REJECT", "Qst.ate",
						"B", "c", "ACCEPT", "B", "C", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse9() {
		new bufferMatcher(" A_string-b-#C1#-d0-P----a->C\n A- b ->B-a->U",
				new String[] { "A_string", "C1", "b", "REJECT", "P", "C1",
						"d0", "REJECT", "P", "C", "a", "ACCEPT", "A", "B", "b",
						"ACCEPT", "B", "U", "a", "ACCEPT", }).match();
	}
	...
	public void testFsmParse10() {
		new bufferMatcher(" A_string-b-#C1#-d0-P----a-#C\n A- b -#B-a-#U",
				new String[] { "A_string", "C1", "b", "REJECT", "P", "C1",
						"d0", "REJECT", "P", "C", "a", "REJECT", "A", "B", "b",
						"REJECT", "B", "U", "a", "REJECT", }).match();
	}

	@Test
	public void testFsmParse11() {
		new bufferMatcher("P-c->P<-b-Q_State<-a-P", new String[] { "P", "P",
				"c", "ACCEPT", "Q_State", "P", "b", "ACCEPT", "P", "Q_State",
				"a", "ACCEPT" }).match();
	}
	...
	protected static void checkEx(String whatToParse, String exceptionSubString) {
		...
		try {
			...
			assertTrue("wrong exception thrown: " + e.getMessage()
					+ " instead of " + exceptionSubString
					+ " - related exception", e.getMessage().contains(
					exceptionSubString));
			exceptionThrown = true;
		}

		assertTrue("exception related to " + exceptionSubString
				+ " was not thrown", exceptionThrown);
	}
