...
#else
/* Mingw that is distributed with Cygwin does not include much ( as per C:\cygwin\usr\i686-w64-mingw32\sys-root\mingw\include\sys ).
resource.h is missing and we have to disable the corresponding functionality. */
