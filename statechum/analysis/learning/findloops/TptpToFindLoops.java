...
/**
 * This class is responsible for taking a series of tptp profile sequences and
 * converting them to observations that can be read by findloops (Jourdan et al,
 * Forte 2007).
 * 
...
public class TptpToFindLoops {
	...
	/**
	 * @param args
	 *            first argument is the name of the tptp trace file
	 *            (decompressed) second argument is the name of the findloops
	 *            output file
	 */
	public static void main(String[] args) {
		...
		ClassMethodDefsHandler handler = extractor.getFileToHandler().get(
				tptpFile);
