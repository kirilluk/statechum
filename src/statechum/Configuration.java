...
public class Configuration implements Cloneable {
	...
	/** How long to run learner (in ms), negative (default) means it will not time out.
	 * Important: this value will be scaled based on the CPU frequency correction value,
	 * in order to time out at the same time on different platforms.
	 */
