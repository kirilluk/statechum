...
abstract public class AbstractLearnerGraph<TARGET_TYPE,CACHE_TYPE extends CachedData<TARGET_TYPE,CACHE_TYPE>> 
{
	...
	public static Label generateNewLabel(String label, @SuppressWarnings("unused") Configuration conf)
	{
	...
	public static Label generateNewLabel(int number, @SuppressWarnings("unused") Configuration conf)
	{
		return new StringLabel(Integer.toString(number));
	}
