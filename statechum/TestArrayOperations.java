...
public class TestArrayOperations {
	 ...
	 * 
	 * @param errMsg
	 *            the error to report with an <code>AssertionFailedError</code>
	 *            if not equal.
	 * @param a
	 *            what to compare
	 * @param b
	...
	public static void compare(byte[] what, byte[] with) {
		...
		for (int i = 0; i < what.length; ++i)
			if (what[i] != with[i])
				fail("Elements at position " + i + " differ: expected "
						+ what[i] + ", got " + with[i]);
	}
	...
	/**
	 * Compares two arrays and does a <code>fail</code> if they do not contain
	 * equal elements (according to their <code>equals</code> function).
	 * 
	 * @param what
	 ...
	 * @param with
	 *            the second one
	 * @return true if the two contain equal elements (according to their
	 *         <code>equals</code> function).
	 */
	public boolean testcmp(Object[] what, Object[] with) {
		boolean resultA = ArrayOperations.cmp(what, with, null), resultB = ArrayOperations
				.cmp(with, what, null);
	...
	public void testCompareA() {
		...
		Assert.assertTrue(testcmp(new Object[] { "a", "b" }, new Object[] {
				"a", "b" }));
		Assert.assertTrue(testcmp(new Object[] { "a", null, "b" },
				new Object[] { "a", null, "b" }));
		Assert.assertTrue(testcmp(new Object[] { "a", null }, new Object[] {
				"a", null }));
		Assert
				.assertTrue(testcmp(new Object[] { null },
						new Object[] { null }));

		Assert.assertFalse(testcmp(new Object[] { "a", null }, new Object[] {
				"a", "b" }));
		Assert.assertFalse(testcmp(new Object[] { null },
				new Object[] { new Object() }));
		Assert.assertFalse(testcmp(new Object[] { "a", "c" }, new Object[] {
				"a", "b" }));
		Assert.assertFalse(testcmp(new Object[] { "a" }, new Object[] { "a",
				"b" }));
	}
	...
	public void testCompareB() {
		Assert.assertTrue(testcmp(new Object[] {
				new Object[] { "a", null, "b" }, "a", "b",
				new Object[] { "a", null, "b" } }, new Object[] {
				new Object[] { "a", null, "b" }, "a", "b",
				new Object[] { "a", null, "b" } }));

		Assert.assertTrue(testcmp(
				new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
						"b", new Object[] { "a", null, "b" } }, new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
						"b", new Object[] { "a", null, "b" } }));

		Assert.assertFalse(testcmp(new Object[] {
				new Object[] { "a", null, new Object[] { "a", null }, "b" },
				"a", "b", new Object[] { "a", null, "b" } },
				new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
						"b", new Object[] { "a", null, "b" } }));
		...
		Assert.assertFalse(testcmp(new Object[] {
				new Object[] { "a", null, new Object[] { "a", "b" }, "b" },
				"a", "b", new Object[] { "a", null, "b" } },
				new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
		...
		Assert.assertFalse(testcmp(
				new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "c" }, "a",
						"b", new Object[] { "a", null, "b" } }, new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
						"b", new Object[] { "a", null, "b" } }));
		...
		Assert.assertFalse(testcmp(
				new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
						"b", new Object[] { "a", null } }, new Object[] {
						new Object[] { "a", null,
								new Object[] { "a", null, "b" }, "b" }, "a",
						"b", new Object[] { "a", null, "b" } }));
	}
	...
	/**
	 * Tests appending of non-empty non-null sequences where one of them
	 * contains a null object.
	 */
	@Test
	public void testObjArrayAppendOK2() {
		Object a[] = new Object[] { "1", "2", "3", null, "5" }, b[] = new Object[] {
				"6", "7", "8", "9" };
	...
	/**
	 * Tests appending of a non-empty non-null sequence to the one containing a
	 * single element.
	 */
	@Test
	public void testArrayObjAppend1OK() {
		Object a[] = new Object[] { "1" }, b[] = new Object[] { "6", "7", "8",
				"9" };
		compare(new Object[] { "1", "6", "7", "8", "9" }, ArrayOperations
				.arrayappend(a, b));
	}
	...
	public void testArrayObjAppend2OK() {
		...
		compare(new Object[] { "1", "2", "3", "4", "5", "6" }, ArrayOperations
				.arrayappend(a, b));
	}
	...
	public void testArrayObjAppendEmptyA() {
		...
		compare(new Object[] { "6", "7", "8", "9" }, ArrayOperations
				.arrayappend(a, b));
	}
	...
	public void testArrayObjAppendEmptyB() {
		Object a[] = new Object[] { "1", "2", "3", "4", "5" }, b[] = new Object[] {};
		compare(new Object[] { "1", "2", "3", "4", "5" }, ArrayOperations
				.arrayappend(a, b));
	}
	...
	public void testArrayObjAppendNullA() {
		...
		compare(b, ArrayOperations.arrayappend(null, b));
	}
	...
	public void testArrayObjAppendNullB() {
		...
		compare(a, ArrayOperations.arrayappend(a, null));
	}
	...
	public void testArrayObjAppendToNull() {
		compare(new Object[] { "6" }, ArrayOperations.arrayappend(null, "6"));
	}

	/** Test appending of a null element to a null sequence. */
	@Test
	public void testArrayObjAppendNullToNull() {
		compare(new Object[] { null }, ArrayOperations.arrayappend(null,
				(Object) null));
	}
	...
	public void testArrayObjAppendNullToNonNull() {
		compare(new Object[] { "1", null }, ArrayOperations.arrayappend(
				new Object[] { "1" }, (Object) null));
	}

	/** Test appending of a single element to an empty sequence. */
	@Test
	public void testArrayObjAppendToEmpty() {
		compare(new Object[] { "6" }, ArrayOperations.arrayappend(
				new Object[0], "6"));
	}
	...
	public void testArrayObjAppendNullToEmpty() {
		compare(new Object[] { null }, ArrayOperations.arrayappend(
				new Object[0], (Object) null));
	}

	/** Test appending of an empty sequence, to an emtpy sequence. */
	@Test
	public void testArrayObjAppendEmptyToEmpty() {
		compare(new Object[0], ArrayOperations.arrayappend(new Object[0],
				new Object[0]));
	}
	...
	public void testPower0() {
		Assert.assertNull("the outcome is not null", ArrayOperations.power(
				new Object[] { "hello" }, 0));
	}
	...
	public void testPower1() {
		compare(new Object[] { "hello" }, ArrayOperations.power(
				new Object[] { "hello" }, 1));
	}
	...
	public void testPower2() {
		compare(new Object[] { "hello", "hello" }, ArrayOperations.power(
				new Object[] { "hello" }, 2));
	}

	/**
	 * Tests a raise of a sequence with more than one element, to the power of
	 * 2.
	 */
	@Test
	public void testPowerA() {
		compare(new Object[] { "A", "B", "A", "B" }, ArrayOperations.power(
				new Object[] { "A", "B" }, 2));
	}
	...
	public void testSeries0() {
		Assert.assertNull("the outcome is not null", ArrayOperations.series(
				new Object[] { "hello" }, 0));
	}
	...
	public void testSeries1() {
		compare(new Object[] { null, new Object[] { "hello" } },
				ArrayOperations.series(new Object[] { "hello" }, 1));
	}
	...
	public void testSeries2() {
		compare(new Object[] { null, new Object[] { "hello" },
				new Object[] { "hello", "hello" } }, ArrayOperations.series(
				new Object[] { "hello" }, 2));
	}
	 ...
	 * 
	 * @param what
	 *            a sequence of objects to compare.
	 * @param with
	 *            the sequence to compare it with.
	 */
	protected void setseqCompare(Object[][] what, Object[][] with) {
		class comp implements Comparator {
			public int compare(Object cmp_what, Object cmp_with) {
				if (cmp_what == null || cmp_with == null
						|| !(cmp_what instanceof Object[])
						|| !(cmp_with instanceof Object[]))
				...
				if (a.length < b.length)
					...
					for (int i = 0; i < a.length; ++i) {
						...
						if (a[i] != ArrayOperations.EndOfSequence.End()
								|| b[i] != ArrayOperations.EndOfSequence.End()) {
							if (!(a[i] instanceof String)
									|| !(b[i] instanceof String))
								fail("Element " + i
										+ " of a sequence is not a string");

							int result = ((String) a[i])
									.compareTo((String) b[i]);
							if (result != 0)
								return result;
						}
					}
		...
		TreeSet<Object[]> first = new TreeSet<Object[]>(new comp()), second = new TreeSet<Object[]>(
				new comp());
		first.addAll(Arrays.asList(what));
		second.addAll(Arrays.asList(with));
		...
		if (!first.equals(second)) {
			...
			for (Object[] elem : first) {
				for (Object seq : elem) {
					...
					str.append(ArrayOperations.separator);
				}
			}
			str.append("; Received: ");
	...
	public void testFlatten_simple() {
		setseqCompare(new Object[][] { new Object[] { "a", "b", "c" } },
				ArrayOperations.flatten(new Object[] { "a", "b", "c" }));
	}
	...
	public void testFlatten_simple2() {
		setseqCompare(new Object[][] { new Object[] { "a", "b", "c" } },
				ArrayOperations.flatten(new Object[] { new Object[] { "a" },
						"b", new Object[] { "c" } }));
	}

	/**
	 * Tests flattening of an array with nested singleton arrays and null
	 * elements.
	 */
	@Test
	public void testFlatten_simple3() {
		setseqCompare(new Object[][] { new Object[] { "a", "b", "c" } },
				ArrayOperations.flatten(new Object[] { new Object[] { "a" },
						"b", new Object[] { "c" }, null, null, null }));
	}

	/**
	 * Tests flattening of an array with a null at the beginning and some
	 * singleton arrays.
	 */
	@Test
	public void testFlatten_simple4() {
		setseqCompare(new Object[][] { new Object[] { "a", "b", "c" } },
				ArrayOperations.flatten(new Object[] { null,
						new Object[] { "a" }, "b", new Object[] { "c" } }));
	}

	/**
	 * Tests flattening of an array with nested sequences, containing more than
	 * one element.
	 */
	@Test
	public void testFlatten_A() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "c" },
				new Object[] { "a", "bB", "c" } },
				ArrayOperations.flatten(new Object[] { "a",
						new Object[] { "bA", "bB" }, "c" }));
	}

	/**
	 * Tests that if there are two non-singleton arrays included in the array to
	 * flatten, all combinations of all elements of these arrays are built.
	 */
	@Test
	public void testFlatten_B() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "c", "dA" },
				new Object[] { "a", "bB", "c", "dA" },
				new Object[] { "a", "bA", "c", "dB" },
				new Object[] { "a", "bB", "c", "dB" } }, ArrayOperations
				.flatten(new Object[] { "a", new Object[] { "bA", "bB" }, "c",
						new Object[] { "dA", "dB" } }));
	}
	...
	public void testFlatten_C() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "dA" },
				new Object[] { "a", "bA", "dB" },
				new Object[] { "a", "bB", "dA" },
				new Object[] { "a", "bB", "dB" } }, ArrayOperations
				.flatten(new Object[] { "a", new Object[] { "bA", "bB" }, null,
						new Object[] { "dA", "dB" } }));
	}
	...
	public void testFlatten_D() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "cA", "dA" },
				new Object[] { "a", "bB", "cA", "dA" },
				new Object[] { "a", "bA", "cA", "dB" },
				new Object[] { "a", "bB", "cA", "dB" },
				new Object[] { "a", "bA", "cB", "dA" },
				new Object[] { "a", "bB", "cB", "dA" },
				new Object[] { "a", "bA", "cB", "dB" },
				new Object[] { "a", "bB", "cB", "dB" },
				new Object[] { "a", "bA", "cC", "dA" },
				new Object[] { "a", "bB", "cC", "dA" },
				new Object[] { "a", "bA", "cC", "dB" },
				new Object[] { "a", "bB", "cC", "dB" } }, ArrayOperations
				.flatten(new Object[] { "a", new Object[] { "bA", "bB" },
						new Object[] { "cA", "cB", "cC" },
						new Object[] { "dA", "dB" } }));
	}
	...
	public void testFlatten_E() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "cA", "dA" },
				new Object[] { "a", "bB", "cA", "dA" },
				new Object[] { "a", "bA", "cA", "dB" },
				new Object[] { "a", "bB", "cA", "dB" } }, ArrayOperations
				.flatten(new Object[] { "a", new Object[] { "bA", "bB" },
						new Object[] { "cA" }, new Object[] { "dA", "dB" } }));
	}

	/**
	 * This one tests alternation between `sequence' and `choice'. Initially,
	 * everything is a sequence of choices. Within a choice, one can have
	 * another sequence of choices etc.
	 */
	@Test
	public void testFlatten_F() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "c" },
				new Object[] { "a", "s", "e", "q", "c" },
				new Object[] { "a", "bB", "c" }, new Object[] { "a", "c" } },
				ArrayOperations.flatten(new Object[] {
						"a",
						null,
						new Object[] { "bA", new Object[] { "s", "e", "q" },
								null, "bB" }, "c" }));
	}
	...
	public void testFlatten_G() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "c" },
				new Object[] { "a", "s", "e", "q", "c" },
				new Object[] { "a", "s", "f", "q", "c" },
				new Object[] { "a", "bB", "c" } }, ArrayOperations
				.flatten(new Object[] {
						"a",
						null,
						new Object[] {
								"bA",
								new Object[] { "s", new Object[] { "e", "f" },
										"q" }, "bB" }, "c" }));
	}
	...
	public void testFlatten_empty2() {
		setseqCompare(new Object[0][], ArrayOperations
				.flatten(new Object[] { new Object[0] }));
	}
	...
	/**
	 * Tests flattening of an array containing nulls at different levels of
	 * nestedness.
	 */
	@Test
	public void testFlatten_null1() {
		setseqCompare(new Object[][] { new Object[] { "a", "bA", "c" },
				new Object[] { "a", "bB", "c" }, new Object[] { "a", "c" } },
				ArrayOperations.flatten(new Object[] { "a", null,
						new Object[] { "bA", null, null, "bB" }, "c" }));

	}

	/** Tests flattening of an array with many nulls, at different levels. */
	public void testFlatten_null2() {
		setseqCompare(new Object[][] {}, ArrayOperations.flatten(new Object[] {
				null, null, new Object[] { null, null, null, null }, null }));
	}

	/** Tests flattening of a singleton array with containing a null element. */
	public void testFlatten_null3() {
		setseqCompare(new Object[][] {}, ArrayOperations
				.flatten(new Object[] { null }));
	}
	...
	public void testFlatten_End() {
		setseqCompare(
				new Object[][] {
						new Object[] { "a", "bA",
								ArrayOperations.EndOfSequence.End() },
						new Object[] { "a", "bB", "c" } },
				ArrayOperations.flatten(new Object[] {
						"a",
						new Object[] {
