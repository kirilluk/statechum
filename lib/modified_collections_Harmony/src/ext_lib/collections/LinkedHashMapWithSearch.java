...
/**
 * LinkedHashMapWithSearch is a variant of HarmonyHashMap. Its entries are kept in a
 ...
 * <p>
 * <b>Note:</b> The implementation of {@code LinkedHashMapWithSearch} is not synchronized.
...
public class LinkedHashMapWithSearch<I, K extends  I, V> extends HashMapWithSearch<I, K, V> implements Map<K, V>, MapWithSearch<I, K, V> {
    ...
    /**
     * Constructs a new empty {@code LinkedHashMapWithSearch} instance.
     */
    public LinkedHashMapWithSearch() {
        super();
        accessOrder = false;
        head = null;
    }
    ...
    /**
     * Constructs a new {@code LinkedHashMapWithSearch} instance with the specified
     * capacity.
     * 
     * @param s
     ...
     */
    public LinkedHashMapWithSearch(int s) {
        super(s);
        accessOrder = false;
        head = null;
    }
     ...
     */
    public LinkedHashMapWithSearch(int s, float lf) {
        super(s, lf);
        accessOrder = false;
        head = null;
        tail = null;
     ...
     *             less or equal to zero.
     */
    public LinkedHashMapWithSearch(int s, float lf, boolean order) {
        super(s, lf);
        accessOrder = order;
        head = null;
        tail = null;
    ...
    /**
     * Constructs a new {@code LinkedHashMapWithSearch} instance containing the mappings
     * from the specified map. The order of the elements is preserved.
     * 
     * @param m
     *            the mappings to add.
     */
    public LinkedHashMapWithSearch(Map<? extends K, ? extends V> m) {
        accessOrder = false;
        head = null;
        tail = null;
        putAll(m);
    ...
    private static class AbstractMapIterator<I, K extends  I, V>  {
        ...
        final LinkedHashMapWithSearch<I, K, V> associatedMap;

        AbstractMapIterator(LinkedHashMapWithSearch<I, K, V> map) {
        ...
        public void remove() {
            ...
            LinkedHashMapWithSearch<I, K, V> lhm = associatedMap;
            if (p != null) {
                p.chainForward = n;
                if (n != null) {
                    n.chainBackward = p;
    ...
    private static abstract class IteratorNoModification<I, K extends I, V> extends AbstractMapIterator<I, K, V> {
        ...
        public IteratorNoModification(LinkedHashMapWithSearch<I, K, V> map) {
            super(map);
        }

        @Override
        public void remove() {
            throw new UnsupportedOperationException("modification of iterator is not allowed for LinkedHashMapWithSearch");
        }
    }
    ...
    private static class EntryIterator <I, K extends I, V> extends IteratorNoModification<I, K, V> implements Iterator<Map.Entry<K, V>> {
        ...
        EntryIterator (LinkedHashMapWithSearch<I, K, V> map) {
            super(map);
        }
    ...
    private static class KeyIterator <I, K extends I, V> extends AbstractMapIterator<I, K, V> implements Iterator<K> {
        ...
        KeyIterator (LinkedHashMapWithSearch<I, K, V> map) {
            super(map);
        }
    ...
    private static class ValueIterator <I, K extends I, V> extends IteratorNoModification<I, K, V> implements Iterator<V> {
        ...
        ValueIterator (LinkedHashMapWithSearch<I, K, V> map) {
            super(map);
        }
    ...
    static final class LinkedHashMapEntrySet<IT, KT extends  IT, VT> extends HashMapEntrySet<IT, KT, VT> {
        public LinkedHashMapEntrySet(LinkedHashMapWithSearch<IT, KT, VT> lhm) {
            super(lhm);
        }
        ...
        public Iterator<Map.Entry<KT, VT>> iterator() {
            ...
            return new EntryIterator<>((LinkedHashMapWithSearch<IT, KT, VT>)HashMapWithSearch());
        }

        @Override
        public boolean remove(@SuppressWarnings("unused") Object o) {
            throw new UnsupportedOperationException("modification of entry set is not allowed for LinkedHashMapWithSearch");
        }
    ...
    static final class LinkedHashMapEntry<K, V> extends HashMapWithSearch.Entry<K, V> {
    ...
    @Override
    @SuppressWarnings("unchecked")
    HashMapWithSearch.Entry<K, V>[] newElementArray(int s) {
     ...
     */
    @Override
    HashMapWithSearch.Entry<K, V> createEntry(K key, int index, V value) {
    ...
    HashMapWithSearch.Entry<K, V> createHashedEntry(K key, int index, int hash) {
    ...
    public V put(K key, V value) {
        if (key == null)
            throw new IllegalArgumentException("key cannot be null for LinkedHashMapWithSearch");
        if (value == null)
            throw new IllegalArgumentException("value cannot be null for LinkedHashMapWithSearch");
    ...
    V putImpl(K key, V value) {
        ...
        if (key == null) {
            ...
            if (m == null) {
                ...
                // includes accessOrder since an accessOrder LinkedHashMapWithSearch does
    ...
    void linkEntry(LinkedHashMapEntry<K, V> m) {
        ...
        // of the chain depending on if the LinkedHashMapWithSearch is accessOrder or not
        LinkedHashMapEntry<K, V> p = m.chainBackward;
        LinkedHashMapEntry<K, V> n = m.chainForward;
        if (p == null) {
            if (n != null) {
    ...
    public Set<K> keySet() {
        if (keySet == null) {
            keySet = new AbstractSet<K>() {
                ...
                @Override
                public int size() {
                    return LinkedHashMapWithSearch.this.size();
                }

                @Override
                public void clear() {
                    LinkedHashMapWithSearch.this.clear();
                }

                @Override
                public boolean remove(Object key) {
                    if (containsKey(key)) {
                        LinkedHashMapWithSearch.this.remove(key);
                        return true;
                    }
                    return false;
                }
                ...
                public Iterator<K> iterator() {
                    return new KeyIterator<>(LinkedHashMapWithSearch.this);
                }
                ...
                public boolean add(@SuppressWarnings("unused") K e) {
                    throw new UnsupportedOperationException("modification of key set is not allowed for LinkedHashMapWithSearch");
                }
...
//                }
                ...
                public Iterator<V> iterator() {
                    return new ValueIterator<>(LinkedHashMapWithSearch.this);
                }

                @Override
                public void clear() {
                    throw new UnsupportedOperationException("modification of value set is not allowed for LinkedHashMapWithSearch");
                }
                @Override
                public boolean remove(@SuppressWarnings("unused") Object o) {
                    throw new UnsupportedOperationException("modification of value set is not allowed for LinkedHashMapWithSearch");
