...
public class Synapse implements Runnable {
	...
	public static final OtpErlangAtom 
		...
		msgLearnEDSMMARKOVabstractionrefinement = new OtpErlangAtom("learnEDSMMARKOVabstractionrefinement"),
													...
													if (command.equals(msgLearnEDSMMARKOVcentre) && message.arity() >= 2)
													{
														...
														try
														{
															...
															final ConsistencyChecker checker = new MarkovClassifier.DifferentPredictionsInconsistencyNoBlacklistingIncludeMissingPrefixes();
															{
																...
																ptaToUseForInference = MergeStates.mergeCollectionOfVertices(ptaInitial, null, verticesToMergeInitialMerge, true);
