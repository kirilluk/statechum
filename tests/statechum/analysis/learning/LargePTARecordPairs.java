...
public class LargePTARecordPairs
{
	   ...
	   {
		   ExperimentPaperUAS2 paper = ExperimentPaperUAS2.loadTraces(args, true);
			PTASequenceEngine engine = paper.getCollectionOfTraces().get(ExperimentPaperUAS2.UAVAllSeeds).tracesForUAVandFrame.get(ExperimentPaperUAS2.UAVAllSeeds).get(paper.getMaxFrameNumber());
