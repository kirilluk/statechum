...
public class TestMarkovLearner {
	...
	public void testCreateMarkovMatrix1()
	{
		...
		Assert.assertSame(UpdatableOutcome.negative, matrix.get(new Trace(Arrays.asList(new Label[]{lblA,lblU}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblD,lblC}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblB,lblC}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblA,lblB}),true)));

		Assert.assertSame(UpdatableOutcome.negative, matrix.get(new Trace(Arrays.asList(new Label[]{lblC,lblD}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblA,lblD}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblA}),true)));
		
		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblB}),true)));
		
		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblC}),true)));
		
		Assert.assertSame(UpdatableOutcome.failure, matrix.get(new Trace(Arrays.asList(new Label[]{lblD}),true)));
		
		Assert.assertSame(UpdatableOutcome.negative, matrix.get(new Trace(Arrays.asList(new Label[]{lblU}),true)));
	}	
	...
	public void testCreateMarkovMatrix2()
	{
		...
		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblA,lblU}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblA}),true)));

		Assert.assertSame(UpdatableOutcome.positive, matrix.get(new Trace(Arrays.asList(new Label[]{lblU}),true)));
	}
