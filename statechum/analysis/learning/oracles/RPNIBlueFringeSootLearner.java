	...
	public LearnerGraph learnMachine()
	{
		...
		while(!possibleMerges.isEmpty()){
			...
			while(questionIt.hasNext()){
				...
				Pair<Integer,String> answer = CheckWithEndUser(tentativeAutomaton,question, temp.getVertex(question).isAccept()?AbstractOracle.USER_ACCEPTED:question.size()-1,newPTA.paths.tracePathPrefixClosed(question), new Object [] {"Test"});
