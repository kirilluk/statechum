...
-type erl_dict() :: dict().% for compatibility with Erlang 16, thanks to https://blog.kempkens.io/posts/erlang-17-0-supporting-deprecated-types-without-removing-warnings_as_errors/
