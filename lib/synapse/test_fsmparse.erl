...
uploadtraces_test_() ->
	...
	[
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[aaa]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"Atom "," com.ericsson.otp.erlang.OtpErlangTuple")) end end) end,
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[{[],gg}]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"List "," com.ericsson.otp.erlang.OtpErlangAtom")) end end) end,
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[{pos,gg}]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"Atom "," com.ericsson.otp.erlang.OtpErlangList")) end end) end,
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[{pos,["gg"]}]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"String "," com.ericsson.otp.erlang.OtpErlangAtom")) end end) end,

		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[ {pos,[a]}, aaa] },receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"Atom "," com.ericsson.otp.erlang.OtpErlangTuple")) end end) end,
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[ {pos,[a]}, {[],gg}]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"List "," com.ericsson.otp.erlang.OtpErlangAtom")) end end) end,
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[ {pos,[a]}, {pos,gg}]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"Atom "," com.ericsson.otp.erlang.OtpErlangList")) end end) end,
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,traces,[ {pos,[a]}, {pos,["gg"]}]},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"String "," com.ericsson.otp.erlang.OtpErlangAtom")) end end) end,
...
loadStatemachine_test_() ->
	...
	[
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,loadFSM,{"a",
					  ...
					  ,a
					  ,[wibble,wobble]
					 }},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"String "," com.ericsson.otp.erlang.OtpErlangAtom")) end end) end,
		...
		fun() -> testsynapse:useworker(fun(Pid,Ref) -> Pid!{Ref,loadFSM,#statemachine{
					  ...
					  ,initial_state=a
					  ,alphabet=[wibble,wobble]
					 }},receive {Ref,failure,Text} -> ?assertEqual(true,testsynapse:containsCast(Text,"Atom "," com.ericsson.otp.erlang.OtpErlangTuple")) end end) end,
