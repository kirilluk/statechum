	...
	public LearnerGraph learnMachine(Collection<List<String>> argSPlus, Collection<List<String>> argSMinus) 	{
		...
		while(!possibleMerges.isEmpty()){
			...
			while(questionIt.hasNext()){
				...
				Pair<Integer,String> answer = CheckWithEndUser(new LearnerGraph(model,Configuration.getDefaultConfiguration()),question, AbstractOracle.USER_CANCELLED,AbstractOracle.USER_CANCELLED, new Object [] {"Test"});
